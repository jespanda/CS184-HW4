  ...
  if (in.is_open()) {
    ...
    while (in) {
      if ((str.find_first_not_of(" \t\r\n") != string::npos) && (str[0] != '#')) {
        ...
        // Note that no transforms/stacks are applied to the colors. 
          ...
          if (validinput) {
            ...
            // Set eyeinit upinit center fovy in variables.h 
              ...
              vec3 zvec = glm::normalize(eyeinit - center);
              upinit = Transform::upvector(upinit, zvec);
              fovy = values[9] ;
        ...
        else if (cmd == "sphere" || cmd == "cube" || cmd == "teapot" || cmd == "book" || cmd=="fish" || cmd=="hand") {
          if (numobjects == maxobjects) // No more objects 
            ...
            if (validinput) {
			 ...
			 // }		  
              ...
              else if (cmd == "book") obj -> type = book;
              else if (cmd == "fish") obj -> type = fish;
              else if (cmd == "hand") obj -> type = hand;
              else if (cmd == "cube"){
              		obj -> type = cube ;
